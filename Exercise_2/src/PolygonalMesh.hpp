...
struct PolygonalMesh
{
    ...
    std::map<unsigned int, list<unsigned int>> Cell1DMarkers = {}; ///< Cell1D markers, size 1 x NumberCell1D (marker)

    unsigned int NumberCell2D = 0; ///< number of Cell2D
    std::vector<unsigned int> Cell2DId = {}; ///< Cell2D id, size 1 x NumberCell2D
    std::vector<vector<unsigned int>> Cell2DVertices = {}; ///< Cell2D Vertices indices, size 1 x undefined NumberCell2DVertices in NumberCell2D
    std::vector<vector<unsigned int>> Cell2DEdges = {}; ///< Cell2D Cell1D indices, size 1 x undefined NumberCell2DEdges in NumberCell2D
    std::map<unsigned int, list<unsigned int>> Cell2DMarkers = {}; ///< Cell2D markers, size 1 x NumberCell2D (marker)
};
